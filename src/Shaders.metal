...
// Including header shared between this Metal shader code and Swift/C code
...
vertex ColorInOut vertexShader(Vertex in [[stage_in]],
  ...
  out.position =
      uniforms.projectionMatrix * uniforms.modelViewMatrix * position;
